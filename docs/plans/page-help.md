...
## 9. NEEDS DECISION — **OPEN. PROPOSED resolutions only; ⚑ = owner rules.**

*Nothing below is resolved. Build does not start on any open item. The §9 one-pass happens in chat.*
...
**Sign-off to start build:** §9 has no open blocker · **§3b's one reshape row (§9-12) is approved** · no
component in §4 requires an unresolved amendment (§9-13). **§9-1, §9-2, §9-5, §9-6 are ⚑ owner rulings**
and gate Phases 4, 1, 1 and 7 respectively.
