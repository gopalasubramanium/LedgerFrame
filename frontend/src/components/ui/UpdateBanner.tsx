...
// `version = null`, so the banner simply never renders. The zero-outbound guarantee
...
export function UpdateBanner({ version, href = "/settings", onDismiss }: UpdateBannerProps) {
  ...
  return (
    <span className="lf-banner lf-banner--update" role="status">
